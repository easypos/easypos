...
<body>
<form name="form-report" id="form-report" method="post" action="reportByOperator.do">
 <script type="text/javascript">
   $(function() {  
   $("#btn-save").click(function() {$("#form-report").submit();});   
	});
  </script>  
<div class="path ui-widget-header ui-corner-all" style="padding-left:5px;"><h2>统计（按工号）</h2></div>  
      ...
      <tr><th colspan="2"><%=key%></th></tr>         
        <%
			for (int j = 0; j < types_.size(); j++) {
				...
				String itemvalue = (String) type_.get("operator");
