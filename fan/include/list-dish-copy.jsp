...
<LINK REL="stylesheet" TYPE="text/css" HREF="/fan/resources/css/type1.css"	TITLE="SID OA">
...
<li>
		<div class="content_block">
			<a href="#"><%=viewDatas[i][3]%></a>
			<h2><a href="#"><%=viewDatas[i][1]%></a></h2>
			<p><%=viewDatas[i][4]%>aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</p>
		</div>
	</li>
	<% } %>     
</ul>	
